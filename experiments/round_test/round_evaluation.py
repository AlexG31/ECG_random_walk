...
from round_result_converter import RoundResultConverter, Round2LeadResultConverter
...
class FindBadRecord:
    ...
    def dump_statistics_to_HTML(self, html_file_name):
        ...
        # Copy css to evaluation result folder
        template_css_path = os.path.join(curfolderpath, 'templates',
                'result-table.css')
        save_css_path = os.path.join(os.path.dirname(html_file_name),
                'result-table.css')
        shutil.copyfile(template_css_path, save_css_path)
...
if __name__ == '__main__':
    ...
    # Get converter
    result_converter = Round2LeadResultConverter.convert
